...
<div class="address-list-wrapper">
    <div class="flex-column">
        <div class="address-list gap-y-2">
            ...
            <p class="text-gray-400 my-2">Starting Price: <span class="text-gray-800">Rs.{{ ($estPrice) ?? '--'}}</span></p>
    ...
    <div class="flex-column my-1">
        ...
        <button wire:click="toggleApprove({{$id}})" class="button-icon">{{$isApproved ? 'DISAPPROVE' : 'APPROVE'}}<span class="fas {{$isApproved ? 'fa-ban' : 'fa-check'}}"></span></button>
    </div>
</div>
